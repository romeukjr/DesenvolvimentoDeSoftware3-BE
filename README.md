...
This project a simple prototype to expose an API to [another application](https://github.com/romeukjr/DesenvolvimentoDeSoftware3-FE/) which has the front-end for this project.
